...
let numModified = [...numbers];
numModified[1] = 4.2;
console.log(numModified);

//Add the number 3 to the END of the array.
//Log out the updated array.
let numWithThree = [...numModified];
numWithThree.push(3);
console.log(numWithThree);
...
let sortedNum = [...numWithThree].sort((a, b) => a - b); // FIXED: use 'numWithThree'
let medianIndex = Math.floor(sortedNum.length / 2);
console.log(sortedNum[medianIndex]);
...
//Log out the circle
let circle = { cx: 34, cy: 43, radius: sortedNum[sortedNum.length - 1]};
console.log(circle);
