...
function extractOpponent(game) {
  // If UW is home, opponent is the opponent property
  // If UW is away, opponent is the home property (the team they're playing against)
...
function huskiesLost(game) {
  // If UW is home, they lost if home_score < opponent_score
  // If UW is away, they lost if opponent_score < home_score
  if (game.home === "UW") {
...
console.log(fumbledGames.length.toString());
...
function mostYardsPassing(game1, game2) {
  ...
  if (Object.prototype.hasOwnProperty.call(game1, 'passing_yards') === false) {
    return game2;
  }
  if (Object.prototype.hasOwnProperty.call(game2, 'passing_yards') === false) {
    return game1;
  }
